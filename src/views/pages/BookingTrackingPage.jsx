...
import RiderTrackingMap from '../components/booking/RiderTrackingMap';
...
export default function BookingTrackingPage() {
    const {
        ...
        // NEW: Rider location tracking
        riderLocation,
        userLocation,
    } = useBookingTracking();

    // Determine if map should be shown
    const showMap = ['confirmed', 'assigned', 'on_the_way', 'picked_up', 'in_transit'].includes(booking?.status);
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-gray-100 p-4">
            ...
            <div className="max-w-2xl mx-auto py-8">
                ...
                {/* 🗺️ NEW: Real-Time Rider Tracking Map */}
                {showMap && (
                    <div className="mb-6">
