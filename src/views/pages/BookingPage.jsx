...
import { MAP_CONFIG, STORAGE_KEYS, ERROR_MESSAGES } from "../../utils/constants";
...
export default function BookingPage() {
    ...
    const fare = distance ? viewModel.calculateFare(distance) : 0;
    ...
    function handleBookNow() {
        ...
        const booking = viewModel.createBooking(
            pickup,
            dropoff,
            distance,
            duration,
