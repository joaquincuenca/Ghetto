...
import { FaFacebook, FaEnvelope, FaPhone, FaUserShield, FaMotorcycle } from "react-icons/fa";
        ...
        <div className="min-h-screen bg-gray-950 text-white flex flex-col">
            <nav className="w-full bg-gray-900 border-b border-gray-800 py-4 px-6 md:px-12 flex justify-between items-center sticky top-0 z-50">
                ...
                <ul className="hidden md:flex gap-8 text-gray-300 items-center">
                    ...
                    <li>
                        <div className="flex gap-2">
                            ...
                            <Link
                                to="/rider/login"
                                className="flex items-center gap-2 bg-yellow-600 text-white px-4 py-2 rounded-lg font-semibold hover:bg-yellow-500 transition"
                            >
                                <FaMotorcycle />
                                Rider Login
                            </Link>
                ...
                <ul className="peer-checked:flex hidden absolute top-16 right-6 bg-gray-900 border border-gray-700 rounded-lg flex-col items-start p-4 gap-4 md:hidden shadow-lg">
                    ...
                    <li className="flex flex-col gap-2 w-full">
                        ...
                        <Link
                            to="/rider/login"
                            className="flex items-center gap-2 bg-yellow-600 text-white px-4 py-2 rounded-lg font-semibold hover:bg-yellow-500 transition w-full"
                        >
                            <FaMotorcycle />
                            Rider Login
                        </Link>
            ...
            <section id="home" className="flex flex-col items-center justify-center flex-1 px-6 text-center py-20 md:py-32">
                ...
                <div className="flex gap-4">
                    ...
                    <Link
                        to="/rider/login"
                        className="flex items-center gap-2 bg-gray-800 text-white font-semibold px-6 py-3 rounded-lg hover:bg-gray-700 transition-all shadow-lg border border-gray-700"
                    >
                        <FaMotorcycle />
                        Rider Login
                    </Link>
